...
/*!************************************!*\
  ...
  \************************************/Object.defineProperty(e,"__esModule",{value:!0}),e.cookieConsent=void 0;var a=function(e,t){if(!t&&e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};t=r(t);if(t&&t.has(e))return t.get(e);var i,o={},n=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(i in e){var s;"default"!==i&&Object.prototype.hasOwnProperty.call(e,i)&&((s=n?Object.getOwnPropertyDescriptor(e,i):null)&&(s.get||s.set)?Object.defineProperty(o,i,s):o[i]=e[i])}o.default=e,t&&t.set(e,o);return o}(s(/*! ./utils/methods */"./src/js/utils/methods.js"));function r(e){if("function"!=typeof WeakMap)return null;var t=new WeakMap,i=new WeakMap;return(r=function(e){return e?i:t})(e)}function t(t,e){var i,o=Object.keys(t);return Object.getOwnPropertySymbols&&(i=Object.getOwnPropertySymbols(t),e&&(i=i.filter(function(e){return Object.getOwnPropertyDescriptor(t,e).enumerable})),o.push.apply(o,i)),o}function o(o){for(var e=1;e<arguments.length;e++){var n=null!=arguments[e]?arguments[e]:{};e%2?t(Object(n),!0).forEach(function(e){var t,i;t=o,e=n[i=e],i in t?Object.defineProperty(t,i,{value:e,enumerable:!0,configurable:!0,writable:!0}):t[i]=e}):Object.getOwnPropertyDescriptors?Object.defineProperties(o,Object.getOwnPropertyDescriptors(n)):t(Object(n)).forEach(function(e){Object.defineProperty(o,e,Object.getOwnPropertyDescriptor(n,e))})}return o}var l=document.querySelector.bind(document),n={cookies:{necessary:{},analytics:{},marketing:{}}},p={initobj:!1,setupcomplete:!1,allasked:!1,checkedlocal:!1,agreeAll:!0,cookies:{},approved:{},settings:{cookieExpire:365,position:"overlay",showTypeDescription:!0},strings:{notificationTitle:"Diese Webseite verwendet Cookies",notificationDescription:'Diese Webseite verwendet Cookies, um Ihnen ein optimales Erlebnis bieten zu können. Dazu gehören ggf. notwendige Cookies, durch welche unsere Webseite alle Funktionen bereitstellen kann, und Performance Cookies um unsere Webseite schneller zu machen. Weiterhin setzen wir ggf. Cookies zur Erstellung anonymer Statistiken oder für die Anzeige und Funktion personalisierter (Werbe-) Inhalte. Weitere Informationen, auch zu Ihrem jederzeitigen Widerrufsrecht, finden Sie in unserer <a href="{{ link }}">{{ linkText }}</a>.<br>',defaultTitle:"Title",defaultDescription:"Description",necessaryTitle:"Notwendig",necessaryDescription:"Diese Cookies sind notwendig, damit unsere Webseite wie z.B. das Navigieren oder der Zugang zu persönlichen Bereichen ordnungsgemäß funktioniert. Ohne diese Cookies würde unsere Webseite nicht einwandfrei funktionieren.",analyticsDefaultTitle:"Statistik",analyticsDefaultDescription:"Statistische Cookies helfen uns zu verstehen wie die Besucher mit unserer Webseite interagieren. Dazu erfassen wir Informationen wie Besucherzahlen, Aufenthaltszeiten und Ähnliches.",marketingTitle:"Marketing / Tracking",marketingDescription:"Diese Cookies nutzen wir, um Besucher über verschiedene Webseiten zu identifizieren. Ziel ist es den Besuchern für sie relevante und interessante Werbung anzeigen zu können.",seeDetails:"Details anzeigen",hideDetails:"Details ausblenden",savePreference:"Einstellungen speichern",allowCookies:"Alle Cookies akzeptieren",link:"/de/Datenschutzerklaerung.htm",linkText:"Datenschutzerklärung"},initiliazePiwik:function(e,t){var i=i||[];i.push(["trackPageView"]),i.push(["enableLinkTracking"]);i.push(["setTrackerUrl",t+"piwik.php"]),i.push(["setSiteId",e]);i=document.createElement("script"),e=document.getElementsByTagName("script")[0];i.type="text/javascript",i.async=!0,i.defer=!0,i.src=t+"piwik.js",e.parentNode.insertBefore(i,e)},initializeGTM:function(e){!function(e,t,i,o){e[i]=e[i]||[],e[i].push({"gtm.start":(new Date).getTime(),event:"gtm.js"});i=t.getElementsByTagName("script")[0],t=t.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtm.js?id="+o,i.parentNode.insertBefore(t,i)}(window,document,"dataLayer",e)},setup:function(){for(var[e,t]of Object.entries(p.initobj.cookies))"analytics"===e?(p.initobj.cookies[e].title=p.strings.analyticsDefaultTitle,p.initobj.cookies[e].description=p.strings.analyticsDefaultDescription):"marketing"===e?(p.initobj.cookies[e].title=p.strings.marketingTitle,p.initobj.cookies[e].description=p.strings.marketingDescription):"necessary"===e?(p.initobj.cookies[e].title=p.strings.necessaryTitle,p.initobj.cookies[e].description=p.strings.necessaryDescription):(p.initobj.cookies[e].title=p.strings.defaultTitle,p.initobj.cookies[e].description=p.strings.defaultDescription),t.defaultstate||(p.initobj.cookies[e].defaultstate="on"),p.initobj.cookies[e].asked=!1,p.initobj.cookies[e].approved=!1,p.initobj.cookies[e].executed=!1;for(var[i,o]of Object.entries(p.cookies))l("#cookieConsent-checkbox-"+i).setAttribute("checked","checked"),this.parentElement.classList.remove("cookie-consent-notification-permissions-inactive");for(var n in p.initobj.cookies)p.cookies[n]=p.initobj.cookies[n]},initialise:function(e){if(p.initobj=o(o({},n),e),void 0!==e.settings&&"undefined"!==e.settings)for(var t in e.settings)this.settings[t]=e.settings[t];if(void 0!==e.strings&&"undefined"!==e.strings)for(var i in e.strings)this.strings[i]=e.strings[i];p.setupcomplete=!0,p.setup()},showConsentBox:function(e){var t=l("#cookie-consent-notification"),i=p.strings.notificationDescription.replace("{{ link }}",p.strings.link).replace("{{ linkText }}",p.strings.linkText),i='<div id="cookie-consent-notification" class="position-'+p.settings.position+'"><div id="cookie-consent-notification-wrapper"><div class="cookie-consent-notification-headline">'+p.strings.notificationTitle+'</div><div class="cookie-consent-notification-content"><p>'+i+'</p></div><div id="cookie-consent-notification-permissions"></div><ul class="cookie-consent-notification-buttons"><li><a class="cookieConsent-link btn -primary -full-mobile" href="#" id="cookieConsent-approve-button-thissite">'+p.strings.allowCookies+"</a></li></ul></div></div>";t&&t.remove(),document.body.innerHTML=i+document.body.innerHTML,t&&(t.style.display="none");var o,n,s,i=document.createElement("ul");l("#cookie-consent-notification-permissions").prepend(i);for([o,n]of e)n.asked||(l("#cookie-consent-notification-permissions ul").innerHTML+='<li><input type="checkbox" checked="checked" id="cookieConsent-checkbox-'+o+'" /><label id="cookieConsent-label-'+o+'" for="cookieConsent-checkbox-'+o+'"><strong>'+n.title+"</strong> "+(p.settings.showTypeDescription?n.description:"")+"</label></li>",(s=l("#cookieConsent-checkbox-"+o)).addEventListener("input",function(e){this.checked?this.parentElement.classList.remove(c):this.parentElement.classList.add(c)}),"off"===n.defaultstate&&"necessary"!==o&&(s.checked=!1,s.parentElement.classList.add(c)),"necessary"===o&&(s.disabled=!0));l(".cookie-consent-notification-buttons").innerHTML+='<li class="text-right"><a class="cookieConsent-link btn -default -full-mobile" href="#" id="cookie-consent-notification-moreinfo">'+p.strings.seeDetails+"</a></li>";var r=l("#cookieConsent-approve-button-thissite"),c="cookie-consent-notification-permissions-inactive";l("#cookie-consent-notification-moreinfo").addEventListener("click",function(){if(this.innerHTML===p.strings.seeDetails){r.innerHTML=p.strings.savePreference,this.innerHTML=p.strings.hideDetails;for(var[e,t]of Object.entries(p.cookies))"necessary"!==e&&(l("#cookieConsent-checkbox-"+e).checked=!1,this.parentElement.classList.add(c))}else{for(var[i,o]of Object.entries(p.cookies))l("#cookieConsent-checkbox-"+i).checked=!0,this.parentElement.classList.remove(c);this.innerHTML=p.strings.seeDetails,r.innerHTML=p.strings.allowCookies}return a.slideToggle(l("#cookie-consent-notification-permissions")),this.blur(),!1}),t&&a.fadeIn(t,"block"),r&&r.addEventListener("click",p.onLocalConsentGiven)},checkapproval:function(){p.allasked=!0;for(var[e,t]of Object.entries(p.cookies))p.approved[e]?"true"===p.approved[e]?(p.cookies[e].asked=!0,p.cookies[e].approved=!0):"false"===p.approved[e]?(p.cookies[e].asked=!0,p.cookies[e].approved=!1):p.allasked=!1:p.allasked=!1;p.allasked||(p.checkedlocal?p.showConsentBox(Object.entries(p.cookies)):p.checklocal())},checklocal:function(){this.checkedlocal=!0;for(var[e,t]of Object.entries(p.cookies)){var i=p.getCookie("cc_"+e);i&&(p.approved[e]=i)}this.checkapproval()},getCookie(e){return(e=document.cookie.match(new RegExp("(?:^|;\\s*)"+e.replace(/([.*+?^${}()|[\]/\\])/g,"\\$1")+"=([^;]*)")))?e[1]:null},setCookie(e,t,i){t=e+"="+encodeURIComponent(t);"number"==typeof i&&(t+="; max-age="+24*i*60*60,document.cookie=t)},onLocalConsentGiven:function(){var e,t,i=!1;for([e,t]of Object.entries(p.cookies))this.classList.contains("cookieConsent-button-enable-"+e)&&(i=!0,p.approved[e]="true",p.cookies[e].asked=!0,p.setCookie("cc_"+e,p.approved[e],p.settings.cookieExpire));if(p.agreeAll=!0,!i)for(var[o,n]of Object.entries(p.cookies))n.approved||n.asked||(l("#cookieConsent-checkbox-"+o).checked?(p.approved[o]="true",p.cookies[o].asked=!0):(p.approved[o]="false",p.cookies[o].asked=!0,p.agreeAll=!1),p.setCookie("cc_"+o,p.approved[o],p.settings.cookieExpire));return a.fadeOut(l("#cookie-consent-notification")),p.checkapproval(),!1},onFirstLoad:function(){!p.setupcomplete&&p.initobj&&(p.setupcomplete=!0,p.setup()),setTimeout(()=>{for(var[e,t]of Object.entries(p.cookies)){var i=l(".cookieConsent-button-enable-"+e);i&&(i.addEventListener("click",p.onLocalConsentGiven),i.classList.add("cookieConsent-link"),p.simulateClick(l(".cookieConsent-button-enable-"+e)))}},50),p.checkapproval()},simulateClick:e=>{var t=new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window});e.dispatchEvent(t)}};e.cookieConsent=p,window.cookieConsent=p}(),
/*!****************************************!*\
